...
- [`weird_conflicts()`](https://pkg.robjhyndman.com/weird/reference/weird_conflicts.md)
  : Conflicts between weird packages and other packages
- [`weird_packages()`](https://pkg.robjhyndman.com/weird/reference/weird_packages.md)
