...
In this example, they only detect (at most) the tiny 1-second duration, and the 30 second duration, both of which are almost certainly recording errors. An explanation of these tests is provided in [Chapter 4 of the book](https://otexts.com/weird/04-tests.html)
